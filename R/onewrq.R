...
#' @param seed
#' @param intermittent
#' @import stringr tidyr quantreg foreach doParallel
#' @return
#' @export
#'
#' @examples
.onewrq <-function(form, tau, data, Y, X1, X2, subject, death, time, interval.death, impute, weight, wcompute, seed, intermittent)
    {
        ## graine
        set.seed(seed)
