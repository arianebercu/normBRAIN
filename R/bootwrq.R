...
#' @param MPI
#' @param cov
#' @import stats quantreg foreach doParallel stringr
#' @return
#' @export
#'
#' @examples
bootwrq <-function(B, form, tau, data, Y, X1=NULL, X2=NULL, subject, death, time, interval.death=NULL, impute=NULL, weight=NULL, wcompute=2, seed=NULL, intermittent, file=NULL, nproc=1, MPI=FALSE,cov=F)
{
    ## verif arguments
  ...
  #browser()
    ...
    if(!exists("res")){return("Problem as rq is  singular")}
